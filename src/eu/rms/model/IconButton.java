...
public class IconButton {
	...
	public static Image getGears2x() {
		return gears2x;
	}

	public static Image getGears3x() {
		return gears3x;
	}

	public static Image getExit1x() {
		return exit1x;
	}

	public static Image getExit2x() {
		return exit2x;
	}

	public static Image getExit3x() {
		return exit3x;
	}

	public static Image getInfo1x() {
		return info1x;
	}

	public static Image getInfo2x() {
		return info2x;
	}

	public static Image getInfo3x() {
		return info3x;
	}

	public static Image getHouse1x() {
		return house1x;
	}

	public static Image getHouse2x() {
		return house2x;
	}

	public static Image getHouse3x() {
		return house3x;
	}

	public static Image getDisplay1x() {
		return display1x;
	}

	public static Image getDisplay2x() {
		return display2x;
	}

	public static Image getDisplay3x() {
		return display3x;
	}

	public static Image getTimetable1x() {
		return timetable1x;
	}

	public static Image getTimetable2x() {
		return timetable2x;
	}

	public static Image getTimetable3x() {
		return timetable3x;
	}

	public static Image getCalendar1x() {
		return calendar1x;
	}

	public static Image getCalendar2x() {
		return calendar2x;
	}

	public static Image getCalendar3x() {
		return calendar3x;
	}

	public static Image getRouteend1x() {
		return routeEnd1x;
	}

	public static Image getRouteend2x() {
		return routeEnd2x;
	}

	public static Image getRouteend3x() {
		return routeEnd3x;
	}

	public static Image getQrcode1x() {
		return qrcode1x;
	}

	public static Image getQrcode2x() {
		return qrcode2x;
	}

	public static Image getQrcode3x() {
		return qrcode3x;
	}

	public static Image getTicket1x() {
		return ticket1x;
	}

	public static Image getTicket2x() {
		return ticket2x;
	}

	public static Image getTicket3x() {
		return ticket3x;
	}

	public static Image getClock1x() {
		return clock1x;
	}

	public static Image getClock2x() {
		return clock2x;
	}

	public static Image getClock3x() {
		return clock3x;
	}

	public static Image getUser1x() {
		return user1x;
	}

	public static Image getUser2x() {
		return user2x;
	}

	public static Image getUser3x() {
		return user3x;
	}

	public static Image getCross1x() {
		return cross1x;
	}

	public static Image getCross2x() {
		return cross2x;
	}

	public static Image getCross3x() {
		return cross3x;
	}

	public static Image getMagglasswhite() {
		return magGlassWhite;
	}
